    ...
    <div className="h-dvh w-screen overflow-hidden bg-[#161616]">
      ...
      {preparation && managerIntroOpen && !preparationOpen && (
        <aside
          ...
          className="fixed right-4 bottom-4 z-40 w-[min(360px,calc(100vw-2rem))] overflow-hidden rounded-2xl border-4 border-[#161616] bg-[#edf5ff] shadow-lg"
        >
          <h2 className="border-b-4 border-[#161616] bg-[#d0e2ff] px-4 py-2 text-lg font-bold text-[#161616]">
            A word from your manager
          </h2>
          <div className="space-y-3 p-4 text-sm leading-relaxed text-[#161616]">
            <p>
            ...
            <button
              ...
              className="rounded-lg border-2 border-[#161616] bg-[#002d9c] px-4 py-2 font-bold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#205578]"
            >
              Got it!
            </button>
          </div>
