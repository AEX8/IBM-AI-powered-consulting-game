...
const STYLES = `
    ...
    .l4-shell,.l4-shell *{box-sizing:border-box}.l4-shell{width:100%;height:100%;padding:10px;background:#d0e2ff;border:7px solid #161616;border-radius:18px;font-family:Arial,sans-serif;color:#161616;box-shadow:0 20px 48px #0008;animation:l4-open .45s cubic-bezier(.2,.9,.3,1.2)}
    .l4-panel{position:relative;display:flex;height:100%;min-height:0;flex-direction:column;overflow:hidden;border:5px solid #161616;border-radius:14px;background:#f4f7f9}.l4-head{height:92px;flex:0 0 92px;display:grid;place-items:center;background:#d0e2ff;border-bottom:5px solid #161616;font-size:27px;font-weight:800}.l4-close{position:absolute;right:15px;top:16px;z-index:4;width:48px;height:48px;border:4px solid #161616;border-radius:50%;background:#fff;font-size:28px;cursor:pointer;transition:.18s}.l4-close:hover{transform:rotate(90deg) scale(1.08)}
    .l4-transcript{min-height:0;flex:1;overflow-y:auto;padding:22px}.l4-message{display:flex;gap:12px;align-items:flex-start;margin:0 0 16px}.l4-message.player{flex-direction:row-reverse}.l4-message img{width:54px;height:54px;border:3px solid #161616;border-radius:50%;background:#fff;object-fit:contain}.l4-message p{max-width:380px;margin:0;border:2px solid #9ba4aa;border-radius:14px;background:#fff;padding:13px 15px;font-size:16px;line-height:1.38}.l4-message.player p{border-color:#78a9ff;background:#edf5ff}
    ...
    .l4-controls{flex:0 0 auto;padding:14px 18px 18px}.l4-choices{display:grid;gap:8px;border:3px solid #78a9ff;border-radius:15px;background:#edf5ff;padding:10px}.l4-choices button{border:3px solid #161616;border-radius:11px;background:#002d9c;padding:12px 15px;color:#fff;text-align:left;font-size:14px;font-weight:700;cursor:pointer;transition:.16s}.l4-choices button:not(:disabled):hover{transform:translateX(5px);filter:brightness(1.08)}.l4-choices button:disabled{opacity:.5;cursor:not-allowed}
    .l4-compose{position:relative;display:grid;grid-template-columns:1fr 62px;gap:9px}.l4-compose textarea{height:82px;border:3px solid #78a9ff;border-radius:13px;padding:12px 14px;font:16px Arial;resize:none}.l4-compose textarea:disabled{background:#eee}.l4-compose [data-send]{border:4px solid #161616;border-radius:13px;background:#002d9c;color:#fff;font-size:28px;cursor:pointer}.l4-compose [data-send]:disabled{opacity:.5;cursor:not-allowed}.l4-end{grid-column:1/-1;margin-top:15px;border:3px solid #161616;border-radius:10px;background:#001d6c;padding:10px;color:#fff;font-weight:700;cursor:pointer}.l4-end:disabled{opacity:.5;cursor:not-allowed}
    .l4-notice,.l4-error{display:grid;gap:12px;justify-items:start;border:3px solid #78a9ff;border-radius:15px;background:#edf5ff;padding:16px}.l4-error{border-color:#b5533c;background:#fdeeea}.l4-notice p,.l4-error p{margin:0;font-size:15px;line-height:1.4}.l4-notice button,.l4-error button{border:3px solid #161616;border-radius:10px;background:#002d9c;padding:10px 18px;color:#fff;font-weight:800;cursor:pointer}
    .l4-spinner{width:26px;height:26px;border:4px solid #d0e2ff;border-top-color:#002d9c;border-radius:50%;animation:l4-spin .8s linear infinite}
    .l4-feedback{position:absolute;inset:0;display:flex;flex-direction:column;background:#f4f7f9}.l4-feedback-head{flex:0 0 90px;display:grid;place-items:center;background:#d0e2ff;border-bottom:5px solid #161616;color:#fff;font-size:27px;font-weight:800}.l4-feedback-body{flex:1;min-height:0;overflow-y:auto;padding:22px 30px 26px}
    .l4-summary{display:flex;align-items:center;gap:20px;margin-bottom:8px}.l4-score{display:grid;flex:0 0 112px;width:112px;height:112px;place-items:center;border:6px solid #161616;border-radius:50%;background:#fff;font-size:44px;font-weight:900;animation:l4-score .7s ease-out}.l4-verdict{margin:0 0 8px;font-size:17px;font-weight:800;line-height:1.35}.l4-verdict.pass{color:#002d9c}.l4-verdict.fail{color:#9b442f}.l4-xp{display:inline-block;border:3px solid #161616;border-radius:20px;background:#edf5ff;padding:3px 12px;font-weight:800}
    .l4-row{display:flex;justify-content:space-between;margin:12px 0 4px;font-size:15px;font-weight:700}.l4-meter{height:20px;border-radius:14px;background:#d0e2ff;overflow:hidden}.l4-meter i{display:block;height:100%;animation:l4-meter 1s ease-out}.l4-meter.good i{background:#002d9c}.l4-meter.fair i{background:#78a9ff}.l4-meter.low i{background:#b5533c}
    ...
    .l4-actions{display:flex;flex-wrap:wrap;gap:12px;margin-top:22px}.l4-actions button{border:4px solid #161616;border-radius:11px;background:#002d9c;padding:12px 22px;color:#fff;font-size:16px;font-weight:800;box-shadow:4px 4px 0 #161616;cursor:pointer}.l4-actions button.secondary{background:#fff;color:#161616}
